#!/usr/bin/env python3
"""
Recuperation des codes promo SodaStream depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/sodastream.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/sodastream.fr"
STORE_NAME = "SodaStream"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour SodaStream depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-sodastream)"
    }
    try:
